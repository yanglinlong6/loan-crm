...
public class CustomerApplyController {
    ...
    @ResponseBody
    public R applyWithZXF(@RequestBody ZxfCustomerBO customer) {
...
//            }
            ...
            if(null != byMD5){
                return R.fail("202","您的申请已提交,请勿重复申请",false);
            }
