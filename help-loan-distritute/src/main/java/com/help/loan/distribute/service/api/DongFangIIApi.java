...
// * 东方融资网：apiSender_
// */
//public class DongFangIIApi implements ApiSender {
//
//    private static final Logger LOG = LoggerFactory.getLogger(DongFangIIApi.class);
//
//    /**撞库地址*/
...
//
//    private static final  int utmSource = 758;
//
//    @Autowired
...
//        }catch (Exception e){
//            LOG.error("[东方融资网II]分发异常：手机-{}",po.getMobile(),e);
//            dispatcheRecDao.add(getDispatcheRecPO(po.getOrgId(),po.getId(),2,e.getMessage()));
//            return new SendResult(false,"[东方融资网II]分发异常："+e.getMessage());
//        }
//    }
//
...
//            return new SendResult(false, "[东方融资网II]用户-" + po.getMobile() + "已注册");
//        }
//    }
//
...
//        userJson.put("HaveCar", JudgeUtil.in(po.getCar(),1,2)?1:2);
//        userJson.put("HaveHouse", JudgeUtil.in(po.getHouse(),1,2)?1:2);
//        userJson.put("SocialSecurityFund", po.getPublicFund().contains("有")?8:1);
//        userJson.put("HaveInsurance", JudgeUtil.in(po.getInsurance(),1,2)?1:2);
//        if(JudgeUtil.in(po.getCompany())){
//            userJson.put("Identity", 1);
//        }else{
//            userJson.put("Identity", 8);
//        }
...
//            return new SendResult(true,"[东方融资网II]用户-"+po.getMobile()+"注册成功");
//        }
//        dispatcheRecDao.add(getDispatcheRecPO(po.getOrgId(),po.getId(),2,registResult));
//        return new SendResult(false,"[东方融资网II]用户-"+po.getMobile()+"注册：未知失败");
//    }
//
//
//    public static void main(String[] args){
//
//        DongFangIIApi api = new DongFangIIApi();
//
