...
/**
 *  新欣科技-无锡:apiSender_20105
 */
@Component("apiSender_20105")
public class XinXinWXApi implements ApiSender {
    private static Logger LOG = LoggerFactory.getLogger(XinXinWXApi.class);
    ...
    public SendResult send(UserAptitudePO po, UserDTO select) {
        try {
            ...
            LOG.error("[新欣科技-无锡]推送异常：{}",e.getMessage(),e);
            dispatcheRecDao.add(getDispatcheRecPO(po.getOrgId(),po.getId(),2,"[新欣科技-无锡]推送异常"));
...
//        }
        ...
        LOG.info("[新欣科技-无锡]推送结果：{}",parseObject);
    ...
    private String sha1(String param) {
        try {
            ...
            LOG.error("[新欣科技-无锡]推送加密异常：{}",e.getMessage(),e);
        }
        return null;
    }
    ...
    private String paramSplicing(LinkedMultiValueMap<String, Object> paramsMap) {
        ...
        LOG.info("send [新欣科技-无锡] signature = " + result);
        return result;
    }
