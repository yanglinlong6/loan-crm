package com.help.loan.distribute.common.utils.excel;
...
public class XLSXCovertCSVReader
{
	...
	private List<String[]> process() throws IOException,OpenXML4JException,ParserConfigurationException,SAXException
	{
	 ...
	 * @throws IOException 
	 */
	public static List<String[]> readerExcel(File file,String sheetName,int minColumns) throws IOException,OpenXML4JException,ParserConfigurationException,SAXException
	{
		...
		for(String[] row:list)
		{
			String[] row2 = new String[row.length];
			int index = 0;
			for(String s:row)
			{
	...
	/**
	 * 
	 * @param input {@link InputStream} excel文件输入流
	 * @param sheetName  sheet名称 
	 * @param minColumns 总列数
	 * @return
	 * @throws IOException
	 * @throws OpenXML4JException
	 * @throws ParserConfigurationException
	 * @throws SAXException
	 */
	public static List<String[]> readerExcel(InputStream input,String sheetName,int minColumns) throws IOException,OpenXML4JException,ParserConfigurationException,SAXException
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		File file = new File("C:\\Users\\Administrator.DESKTOP-6C8VQSE\\Desktop\\机构优质率报表\\渠道优质率报表5-12.xlsx");
		
		System.out.println(file.getName());
		List<String[]> list = XLSXCovertCSVReader.readerExcel(file,"Sheet1",9);
...
//			}
//		}
//		wb.write(new FileOutputStream("D:"+File.pathSeparator+"table.xls"));
