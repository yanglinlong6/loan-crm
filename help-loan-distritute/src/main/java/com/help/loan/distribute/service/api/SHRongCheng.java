...
/**
 * 上海融成 apiSender_10019
 */
@Component("apiSender_10019")
public class SHRongCheng implements ApiSender {

    private static final Logger log = LoggerFactory.getLogger(SHRongCheng.class);
    ...
    public SendResult send(UserAptitudePO po, UserDTO select) {
        ...
        try{
            ...
            dispatcheRecDao.add(getDispatcheRecPO(po.getOrgId(),po.getId(),2,"【上海融成】："+e.getMessage()));
            log.error("【上海融成】：{}",e.getMessage(),e);
            return new SendResult(false,"【上海融成】："+e.getMessage());
        }
    }
