...
/**
 *  新欣科技-南京:apiSender_20047
 */
@Component("apiSender_20047")
public class XinXinNJApi implements ApiSender {
    private static Logger LOG = LoggerFactory.getLogger(XinXinNJApi.class);
    ...
    public SendResult send(UserAptitudePO po, UserDTO select) {
        try {
            ...
            LOG.error("【新欣科技-南京】推送异常：{}",e.getMessage(),e);
            dispatcheRecDao.add(getDispatcheRecPO(po.getOrgId(),po.getId(),2,"【新欣科技-南京】推送异常"));
    ...
    private SendResult send2(UserAptitudePO po, UserDTO select){
        ...
        LOG.info("【新欣科技-南京】推送结果：{}",parseObject);
    ...
    private String sha1(String param) {
        try {
            ...
            LOG.error("【新欣科技-南京】推送加密异常：{}",e.getMessage(),e);
        }
        return null;
    }
    ...
    private String paramSplicing(LinkedMultiValueMap<String, Object> paramsMap) {
        ...
        LOG.info("send 【新欣科技-南京】 signature = " + result);
        return result;
    }
