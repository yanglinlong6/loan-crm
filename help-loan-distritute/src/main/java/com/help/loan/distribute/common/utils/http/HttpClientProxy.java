package com.help.loan.distribute.common.utils.http;
...
public class HttpClientProxy {
    ...
    public static String doPostWithFormDate(String url,String contentType, JSONObject data) throws IOException {

        if(StringUtils.isEmpty(url) || null == data || data.isEmpty() || StringUtils.isEmpty(contentType)){
            return null;
        }
        MultipartEntityBuilder entity = MultipartEntityBuilder.create()
                .setMode(HttpMultipartMode.BROWSER_COMPATIBLE)
                .setCharset(Charset.forName(defineCharset));
        Iterator<String> it = data.keySet().iterator();
        while (it.hasNext()){
            String key = it.next();
            entity.addPart(key, new StringBody(data.get(key).toString(),ContentType.create(contentType)));
        }
    ...
    private static String excuteHttpClient(HttpRequestBase method) {
        ...
        try {
            ...
            if(code == HttpStatus.SC_OK) {
                ...
                log.error("请求地址【{}】，异常信息【{}】,HTTP状态码:[{}]", content, defineCharset,code);
                return content;
            }
    ...
    public static String doPost(String url, String params, String charset, Integer maxWait, Map<String, String> httpHeader) {
        return excuteHttpClient(defineHttpPost(url, pakegeStringEntity(params, charset == null ? defineCharset : charset), charset, maxWait, httpHeader));
    }
    ...
    public static String doPost(String url, Map<String, File> params, Map<String, String> map, String charset, Integer maxWait, Map<String, String> httpHeader) {
        return excuteHttpClient(defineHttpPost(url, pakegeHttpFileEntity(params, map, charset == null ? defineCharset : charset), charset, maxWait, httpHeader));
    }
    ...
    public static String doPost(String url, Map<String, Object> params, String charset, Integer maxWait, Map<String, String> httpHeader) {
        return excuteHttpClient(defineHttpPost(url, packageHttpEntity(params, charset == null ? defineCharset : charset), charset, maxWait, httpHeader));
    }

    public static String doPost(String url, LinkedMultiValueMap<String, Object> paramsMap, String charset, Integer maxWait, Map<String, String> httpHeader) {
        return excuteHttpClient(defineHttpPost(url, packageHttpEntity(paramsMap, charset == null ? defineCharset : charset), charset, maxWait, httpHeader));
    }
    ...
    public static String doPostWithObject(String url, Map<String, String> params, String charset, Integer maxWait, Map<String, String> httpHeader) {
        return excuteHttpClient(defineHttpPost(url, packageHttpEntityWithObject(params, charset == null ? defineCharset : charset), charset, maxWait, httpHeader));
    }
...
//        builder.setContentType(ContentType.MULTIPART_FORM_DATA);
    ...
    private static UrlEncodedFormEntity packageHttpEntity(LinkedMultiValueMap<String, Object> paramsMap, String charset) {
        List<NameValuePair> formparams = new ArrayList<NameValuePair>();
