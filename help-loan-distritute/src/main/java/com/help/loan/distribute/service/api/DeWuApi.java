...
public class DeWuApi implements ApiSender{

    private static final Logger log = LoggerFactory.getLogger(DeWuApi.class);

    private static final Logger LOG = LoggerFactory.getLogger(DeWuApi.class);


    private static final String URL = "http://dewu.bangzheng100.com/crm/import/customer";

    private static String KEY = "c1b0aaf7281e4365a13986a1dde7e3cd";

    private static Long channelId = 19l;
